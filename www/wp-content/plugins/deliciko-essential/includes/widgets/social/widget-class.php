 ...
 * social widget
 */
class Deliciko_Social extends WP_Widget {

	function __construct() {
		$widget_opt = array(
			'classname'		 => 'delicios-widget',
			'description'	 => esc_html__('Deliciko Social','deliciko-essential')
		);

		parent::__construct( 'xs-social', esc_html__( 'Deliciko social', 'deliciko-essential' ), $widget_opt );
	}

	function widget( $args, $instance ) {
		global $wp_query;

		echo deliciko_return( $args[ 'before_widget' ] );
		if ( !empty( $instance[ 'title' ] ) ) {

			echo deliciko_return( $args[ 'before_title' ] ) . apply_filters( 'widget_title', $instance[ 'title' ] ) . deliciko_return( $args[ 'after_title' ] );
		}
		...
		<?php
		echo deliciko_return( $args[ 'after_widget' ] );
	}
	...
	function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Social', 'delicios' );
		}
		...
		?>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title', 'deliciko-essential' ).':'; ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" />
		</p>
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook:', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'google' ) ); ?>"><?php esc_html_e( 'Google Plus', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'pinterest' ) ); ?>"><?php esc_html_e( 'Pinterest', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>"><?php esc_html_e( 'Instagram', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'behance' ) ); ?>"><?php esc_html_e( 'behance', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'flickr' ) ); ?>"><?php esc_html_e( 'flickr', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'github' ) ); ?>"><?php esc_html_e( 'github', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'soundcloud' ) ); ?>"><?php esc_html_e( 'soundcloud', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'skype' ) ); ?>"><?php esc_html_e( 'skype', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'stumbleupon' ) ); ?>"><?php esc_html_e( 'stumbleupon', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tumblr' ) ); ?>"><?php esc_html_e( 'tumblr', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vimeo' ) ); ?>"><?php esc_html_e( 'vimeo', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vine' ) ); ?>"><?php esc_html_e( 'vine', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'vk' ) ); ?>"><?php esc_html_e( 'vk', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'xing' ) ); ?>"><?php esc_html_e( 'xing', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'yelp' ) ); ?>"><?php esc_html_e( 'yelp', 'deliciko-essential' ).':'; ?></label>
