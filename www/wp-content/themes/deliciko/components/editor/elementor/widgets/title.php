...
class Deliciko_Title_Widget extends Widget_Base {


    public $base;

    public function get_name() {
        return 'delicios-title';
    }

    public function get_title() {
        return esc_html__( 'Title', 'deliciko' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_tab',
            [
                'label' => esc_html__('Title settings', 'deliciko'),
            ]
        );
        ...
        $this->add_control(
         'title_style',
         [
            'label' => esc_html__( 'Title style', 'deliciko' ),
            'type' => Custom_Controls_Manager::IMAGECHOOSE,
            'default' => 'style1',
            'options' => [
               'style1'  => [
                  'title' => esc_html__( 'Style 1', 'deliciko' ),
                        'imagelarge' => DELICIKO_IMG. '/admin/title/style1.png',
                        'imagesmall' => DELICIKO_IMG. '/admin/title/style1.png',
                        'width' => '30%',
               ],
               'style2'  => [
                  'title' => esc_html__( 'Style 2', 'deliciko' ),
                        'imagelarge' => DELICIKO_IMG. '/admin/title/style2.png',
                        'imagesmall' => DELICIKO_IMG. '/admin/title/style2.png',
                        'width' => '30%',
               ],
               'style3'  => [
                  'title' => esc_html__( 'Style 3', 'deliciko' ),
                        'imagelarge' => DELICIKO_IMG. '/admin/title/style3.png',
                        'imagesmall' => DELICIKO_IMG. '/admin/title/style3.png',
                        'width' => '30%',
               ],
      ...
      $this->add_control(
			'title', [
				'label'			=> esc_html__( 'Heading Title', 'deliciko' ),
				'type'			=> Controls_Manager::TEXTAREA,
				'label_block'	=> true,
				'placeholder'	=> esc_html__( 'Breakfast', 'deliciko' ),
				'default'	     => esc_html__( 'why {choose} us', 'deliciko' ),
			]
      );
      ...
      [
      'label'       => esc_html__('Show title border', 'deliciko'),
      ...
      $this->add_group_control(
			...
			$this->add_responsive_control(
				'title_margin',
				[
					'label' => esc_html__( 'Tilte Margin', 'deliciko' ),
      ...
      $this->start_controls_section(
			'section_title_border_style', [
				'label'	 => esc_html__( 'Title border', 'deliciko' ),
            'tab'	 => Controls_Manager::TAB_STYLE,
            'condition' => [
      ...
      $this->add_responsive_control(
			'title_border_color', [
				...
				'selectors'	 => [
					...
					'{{WRAPPER}} .title-bar span' => 'background: {{VALUE}};',
      ...
      $this->add_responsive_control(
			'title_boder_width',
			[
				'label' => __( 'Border width', 'deliciko' ),
      ...
      $this->add_control(
			'title_boder_height',
			[
				'label' => __( 'Border height', 'deliciko' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' => [
      ...
      $this->add_responsive_control(
			'title_margin_bottom',
			[
				'label' => __( 'Border bottom', 'deliciko' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ '%','px' ],
				'range' => [
					'%' => [
      ...
      $this->start_controls_section(
			'section_title_highlight_style', [
				'label'	 => esc_html__( 'Title highlight', 'deliciko' ),
				'tab'	 => Controls_Manager::TAB_STYLE,
			]
      );
      ...
      $this->add_control(
			'title_highlight_color', [
				'label'		 => esc_html__( 'Highlight color', 'deliciko' ),
				'type'		 => Controls_Manager::COLOR,
				'selectors'	 => [
      ...
      $this->add_control(
			...
			[
				'label' => esc_html__( 'Icon typhography', 'deliciko' ),
