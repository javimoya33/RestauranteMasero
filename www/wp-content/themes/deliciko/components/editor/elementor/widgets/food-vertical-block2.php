...
class Deliciko_Post_Vertical_Grid2_Widget extends Widget_Base {

  public $base;

    public function get_name() {
        return 'deliciko-post-vertical-grid2';
    }

    public function get_title() {
        return esc_html__( 'Post vertical grid 2', 'deliciko' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
         ...
         'block_style', [
             'label' => esc_html__('Choose Style', 'deliciko'),
             'type' => Custom_Controls_Manager::IMAGECHOOSE,
             'default' => 'style1',
             'options' => [
               'style1' => [
                  'title' =>esc_html__( 'Style 1', 'deliciko' ),
                        'imagelarge' => DELICIKO_IMG . '/elementor/slider/style1.png',
                        'imagesmall' => DELICIKO_IMG . '/elementor/slider/style1.png',
                        'width' => '50%',
               ],
               'style2' => [
                  'title' =>esc_html__( 'Style 2', 'deliciko' ),
                        'imagelarge' => DELICIKO_IMG . '/elementor/slider/style3.png',
                        'imagesmall' => DELICIKO_IMG . '/elementor/slider/style3.png',
                        'width' => '50%',
               ],
        ...
        $this->add_control(
            'show_desc',
            [
                'label' => esc_html__('Show Desc', 'deliciko'),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => esc_html__('Yes', 'deliciko'),
                'label_off' => esc_html__('No', 'deliciko'),
                'default' => 'yes',
        ...
        $this->add_control(
         'post_content_crop',
         [
           'label'         => esc_html__( 'Post content crop', 'deliciko' ),
           'type'          => Controls_Manager::NUMBER,
           'default'       => '20',
      ...
      $this->add_control(
       ...
       $this->add_control(
        ...
        $this->add_control(
         'desc_color',
         [
            'label' => esc_html__('Desc color', 'deliciko'),
            'type' => Controls_Manager::COLOR,
            'default' => '',
            'condition' => [ 'block_style' => ['style2'] ],
            'selectors' => [
        ...
        $this->add_group_control(
           ...
           [
              ...
              'label' => esc_html__( 'Desc Typography', 'deliciko' ),
              'scheme' => Core\Schemes\Typography::TYPOGRAPHY_1,
              'condition' => [ 'block_style' => ['style2'] ],
