...
// ----------------------------------------------------------------------------------------
function deliciko_option( $key, $default_value = '', $method = 'customizer' ) {
	if ( defined( 'FW' ) ) {
		switch ( $method ) {
			case 'theme-settings':
...
// ----------------------------------------------------------------------------------------
function deliciko_meta_option( $postid, $key, $default_value = '' ) {
	if ( defined( 'FW' ) ) {
...
// ----------------------------------------------------------------------------------------
function deliciko_resize( $url, $width = false, $height = false, $crop = false ) {
...
// ----------------------------------------------------------------------------------------
function deliciko_src( $key, $default_value = '', $input_as_attachment = false ) { // for src
	if ( $input_as_attachment == true ) {
		$attachment = $key;
	} else {
		$attachment = deliciko_option( $key );
	}
...
// ----------------------------------------------------------------------------------------
function deliciko_org_id( $id, $name = true ) {
...
// ----------------------------------------------------------------------------------------
function deliciko_google_fonts_url($font_families	 = []) {
	$fonts_url		 = '';
	if ( $font_families ) {
		$query_args = array(
...
// ----------------------------------------------------------------------------------------
function deliciko_get_mega_item_child_slug( $location, $option_id ) {
	$mega_item	 = '';
...
// ----------------------------------------------------------------------------------------
function deliciko_youtube_cover( $e ) {
	$src = null;
	//get the url
	if ( $e != '' ){
		$url = $e;
...
// ----------------------------------------------------------------------------------------
function deliciko_soundcloud_embed( $url ) {
...
// ----------------------------------------------------------------------------------------
function deliciko_video_embed($url){
...
if ( !function_exists( 'deliciko_advanced_font_styles' ) ) :

	/**
	 * Get shortcode advanced Font styles
	 *
	 */
	function deliciko_advanced_font_styles( $style ) {
...
function deliciko_array_elements_remove( $input ,$elements){
...
// review rating
function deliciko_review_rating($arg = []){
