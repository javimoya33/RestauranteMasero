<?php
/*
* Plugin Name: Deliciko Essentials
* License - GNU/GPL V2 or Later
* Description: This is a required plugin for deliciko theme.
* Version: 1.3
* text domain: deliciko-essential
*/
if ( ! defined( 'ABSPATH' ) ) {
    exit;
}
...
// Add language
add_action( 'init', 'deliciko_language_load' );
function deliciko_language_load(){
    $plugin_dir = basename(dirname(__FILE__))."/languages/";
    load_plugin_textdomain( 'deliciko-essential', false, $plugin_dir );
}

// main class
class Deliciko_Essentials_Includes {
	...
	public static function include_widget( $widget_dir ) {
		...
		register_widget( 'Deliciko_' . self::dirname_to_classname( $widget_dir ) );
	}
...
Deliciko_Essentials_Includes::init();