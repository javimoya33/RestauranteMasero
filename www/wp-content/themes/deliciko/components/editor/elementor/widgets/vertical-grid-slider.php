...
class Deliciko_Vertical_Grid_Slider_Widget extends Widget_Base {

  public $base;

    public function get_name() {
        return 'deliciko-vertical-grid-slider';
    }

    public function get_title() {
        return esc_html__( 'Post vertical grid slider', 'deliciko' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
			...
			[
				'label' => esc_html__( 'slider number', 'deliciko' ),
        ...
        $this->add_control(
			'slider_margin',
			[
				'label' => esc_html__( 'slider margin', 'deliciko' ),
				'type' => \Elementor\Controls_Manager::NUMBER,
				'min' => 1,
				'max' => 50,
				'step' => 1,
