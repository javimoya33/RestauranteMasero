 ...
 * social widget
 */
class Deliciko_Service_Hour extends WP_Widget {

	function __construct() {
		$widget_opt = array(
			'classname'		 => 'delicios-widget',
			'description'	 => esc_html__('Deliciko Service Hour','delicios-essential')
		);

		parent::__construct( 'xs-service', esc_html__( 'Deliciko Service Hour', 'delicios-essential' ), $widget_opt );
	}
	...
	function widget( $args, $instance ) {
		...
		?>
	     ...
	     <ul class="unstyled service-time">
	     	       	<?php if ( $monday != '' ): ?>
                     <li>
                        <span> <?php echo esc_html__("Monday","deliciko-essential"); ?> </span>
                        <span><?php echo esc_html( $monday ); ?></span>
                     </li>
                     <?php endif; ?>
                   	<?php if ( $tuesday != '' ): ?>
                     <li>
                        <span> <?php echo esc_html__("Tuesday","deliciko-essential"); ?> </span>
                        <span><?php echo esc_html( $tuesday ); ?></span>
                     </li>
                     <?php endif; ?>
                     	<?php if ( $wednesday != '' ): ?>
                     <li>
                        <span> <?php echo esc_html__("Wednesday","deliciko-essential"); ?> </span>
                        <span><?php echo esc_html( $wednesday ); ?></span>
                     </li>
                     <?php endif; ?>
                     	<?php if ( $thursday != '' ): ?>
                     <li>
                        <span><?php echo esc_html__("Thursday","deliciko-essential"); ?>  </span>
                        <span><?php echo esc_html( $thursday ); ?></span>
                     </li>
                     <?php endif; ?>
                     	<?php if ( $friday != '' ): ?>
                     <li>
                        <span> <?php echo esc_html__("Friday","deliciko-essential"); ?> </span>
                     ...
                     <?php if ( $saturday != '' ): ?>
                     <li>
                        <span>  <?php echo esc_html__("Saturday","deliciko-essential"); ?></span>
                     ...
                     <?php if ( $sunday != '' ): ?>
                     <li>
                        <span> <?php echo esc_html__("Sunday","deliciko-essential"); ?> </span>
	...
	function form( $instance ) {
		if ( isset( $instance[ 'title' ] ) ) {
			...
			$title = esc_html__( 'Service hour', 'deliciko-essential' );
		}
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'saturday' ) ); ?>"><?php esc_html_e( 'Saturday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'sunday' ) ); ?>"><?php esc_html_e( 'Sunday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'monday' ) ); ?>"><?php esc_html_e( 'Monday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'tuesday' ) ); ?>"><?php esc_html_e( 'Tuesday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'wednesday' ) ); ?>"><?php esc_html_e( 'Wednesday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'thursday' ) ); ?>"><?php esc_html_e( 'Thursday', 'deliciko-essential' ).':'; ?></label>
		...
		<p>
			<label for="<?php echo esc_attr( $this->get_field_id( 'friday' ) ); ?>"><?php esc_html_e( 'Friday', 'deliciko-essential' ).':'; ?></label>
