...
class FW_Option_Type_NewIcon extends FW_Option_Type {
	...
	protected function _enqueue_static( $id, $option, $data ) {
		...
		$uri = DELICIKO_THEME_URI . '/components/option-types/' . $this->get_type() . '/static';
	...
	protected function _render( $id, $option, $data ) {
		...
		return fw_render_view( DELICIKO_COMPONENTS . '/option-types/' . $this->get_type() . '/view.php', compact( 'id', 'option', 'data', 'set' ) );
	}
	...
	private function generate_unknown_set( $icon ) {
		return array(
			...
			'container-class'	 => '',
			'groups'			 => array(
				'unknown' => esc_html__( 'Unknown Set', 'deliciko' ),
			),
			'icons'				 => array(
	...
	private function get_default_sets() {
		return array(
			'font-awesome' => array( // http://fortawesome.github.io/Font-Awesome/icons
				...
				'groups'			 => array(
					'web-application'	 => esc_html__( 'Web Application Icons', 'deliciko' ),
					'hand'				 => esc_html__( 'Hand Icons', 'deliciko' ),
					'transportation'	 => esc_html__( 'Transportation Icons', 'deliciko' ),
					'gender'			 => esc_html__( 'Gender Icons', 'deliciko' ),
					'file-type'			 => esc_html__( 'File Type Icons', 'deliciko' ),
					'payment'			 => esc_html__( 'Payment Icons', 'deliciko' ),
					'currency'			 => esc_html__( 'Currency Icons', 'deliciko' ),
					'text-editor'		 => esc_html__( 'Text Editor Icons', 'deliciko' ),
					'directional'		 => esc_html__( 'Directional Icons', 'deliciko' ),
					'video-player'		 => esc_html__( 'Video Player Icons', 'deliciko' ),
					'brand'				 => esc_html__( 'Brand Icons', 'deliciko' ),
					'medical'			 => esc_html__( 'Medical Icons', 'deliciko' ),
					'deliciko-icons'	 => esc_html__( 'deliciko Icons', 'deliciko' ),
				),
				'icons'				 => array(
					...
					//deliciko Icons
               'icon icon-title' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon11' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon1' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon21' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon2' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon31' => array('group' => 'deliciko-icons'),
               'icon icon-feature_icon3' => array('group' => 'deliciko-icons'),
               'icon icon-funfact_icon1' => array('group' => 'deliciko-icons'),
               'icon icon-funfact_icon2' => array('group' => 'deliciko-icons'),
               'icon icon-funfact_icon3' => array('group' => 'deliciko-icons'),
               'icon icon-menu_icon1' => array('group' => 'deliciko-icons'),
               'icon icon-menu_icon2' => array('group' => 'deliciko-icons'),
               'icon icon-menu_icon3' => array('group' => 'deliciko-icons'),
               'icon icon-menu_icon4' => array('group' => 'deliciko-icons'),
               'icon icon-menu_icon5' => array('group' => 'deliciko-icons'),
               'icon icon-quote' => array('group' => 'deliciko-icons'),
               'icon icon-About-2' => array('group' => 'deliciko-icons'),
               'icon icon-About-3' => array('group' => 'deliciko-icons'),
               'icon icon-About-4' => array('group' => 'deliciko-icons'),
               'icon icon-About' => array('group' => 'deliciko-icons'),
               'icon icon-Banner_current' => array('group' => 'deliciko-icons'),
               'icon icon-Banner_factory-1' => array('group' => 'deliciko-icons'),
               'icon icon-Banner_factory' => array('group' => 'deliciko-icons'),
               'icon icon-Banner_pumpjack' => array('group' => 'deliciko-icons'),
               'icon icon-Funfacts-2' => array('group' => 'deliciko-icons'),
               'icon icon-Funfacts-3' => array('group' => 'deliciko-icons'),
               'icon icon-Funfacts-4' => array('group' => 'deliciko-icons'),
               'icon icon-Funfacts' => array('group' => 'deliciko-icons'),
               'icon icon-mobile' => array('group' => 'deliciko-icons'),
               'icon icon-laptop' => array('group' => 'deliciko-icons'),
               'icon icon-desktop' => array('group' => 'deliciko-icons'),
               'icon icon-tablet' => array('group' => 'deliciko-icons'),
               'icon icon-phone' => array('group' => 'deliciko-icons'),
               'icon icon-document' => array('group' => 'deliciko-icons'),
               'icon icon-documents' => array('group' => 'deliciko-icons'),
               'icon icon-search' => array('group' => 'deliciko-icons'),
               'icon icon-clipboard' => array('group' => 'deliciko-icons'),
               'icon icon-newspaper' => array('group' => 'deliciko-icons'),
               'icon icon-notebook' => array('group' => 'deliciko-icons'),
               'icon icon-book-open' => array('group' => 'deliciko-icons'),
               'icon icon-browser' => array('group' => 'deliciko-icons'),
               'icon icon-calendar' => array('group' => 'deliciko-icons'),
               'icon icon-presentation' => array('group' => 'deliciko-icons'),
               'icon icon-picture' => array('group' => 'deliciko-icons'),
               'icon icon-pictures' => array('group' => 'deliciko-icons'),
               'icon icon-video' => array('group' => 'deliciko-icons'),
               'icon icon-camera' => array('group' => 'deliciko-icons'),
               'icon icon-printer' => array('group' => 'deliciko-icons'),
               'icon icon-toolbox' => array('group' => 'deliciko-icons'),
               'icon icon-briefcase' => array('group' => 'deliciko-icons'),
               'icon icon-wallet' => array('group' => 'deliciko-icons'),
               'icon icon-gift' => array('group' => 'deliciko-icons'),
               'icon icon-bargraph' => array('group' => 'deliciko-icons'),
               'icon icon-grid' => array('group' => 'deliciko-icons'),
               'icon icon-expand' => array('group' => 'deliciko-icons'),
               'icon icon-focus' => array('group' => 'deliciko-icons'),
               'icon icon-edit' => array('group' => 'deliciko-icons'),
               'icon icon-adjustments' => array('group' => 'deliciko-icons'),
               'icon icon-ribbon' => array('group' => 'deliciko-icons'),
               'icon icon-hourglass' => array('group' => 'deliciko-icons'),
               'icon icon-lock' => array('group' => 'deliciko-icons'),
               'icon icon-megaphone' => array('group' => 'deliciko-icons'),
               'icon icon-shield' => array('group' => 'deliciko-icons'),
               'icon icon-trophy' => array('group' => 'deliciko-icons'),
               'icon icon-flag' => array('group' => 'deliciko-icons'),
               'icon icon-map' => array('group' => 'deliciko-icons'),
               'icon icon-puzzle' => array('group' => 'deliciko-icons'),
               'icon icon-basket' => array('group' => 'deliciko-icons'),
               'icon icon-envelope' => array('group' => 'deliciko-icons'),
               'icon icon-streetsign' => array('group' => 'deliciko-icons'),
               'icon icon-telescope' => array('group' => 'deliciko-icons'),
               'icon icon-gears' => array('group' => 'deliciko-icons'),
               'icon icon-key' => array('group' => 'deliciko-icons'),
               'icon icon-paperclip' => array('group' => 'deliciko-icons'),
               'icon icon-attachment' => array('group' => 'deliciko-icons'),
               'icon icon-pricetags' => array('group' => 'deliciko-icons'),
               'icon icon-lightbulb' => array('group' => 'deliciko-icons'),
               'icon icon-layers' => array('group' => 'deliciko-icons'),
               'icon icon-pencil' => array('group' => 'deliciko-icons'),
               'icon icon-tools' => array('group' => 'deliciko-icons'),
               'icon icon-tools-2' => array('group' => 'deliciko-icons'),
               'icon icon-scissors' => array('group' => 'deliciko-icons'),
               'icon icon-paintbrush' => array('group' => 'deliciko-icons'),
               'icon icon-magnifying-glass' => array('group' => 'deliciko-icons'),
               'icon icon-circle-compass' => array('group' => 'deliciko-icons'),
               'icon icon-linegraph' => array('group' => 'deliciko-icons'),
               'icon icon-mic' => array('group' => 'deliciko-icons'),
               'icon icon-strategy' => array('group' => 'deliciko-icons'),
               'icon icon-beaker' => array('group' => 'deliciko-icons'),
               'icon icon-caution' => array('group' => 'deliciko-icons'),
               'icon icon-recycle' => array('group' => 'deliciko-icons'),
               'icon icon-anchor' => array('group' => 'deliciko-icons'),
               'icon icon-profile-male' => array('group' => 'deliciko-icons'),
               'icon icon-profile-female' => array('group' => 'deliciko-icons'),
               'icon icon-bike' => array('group' => 'deliciko-icons'),
               'icon icon-wine' => array('group' => 'deliciko-icons'),
               'icon icon-hotairballoon' => array('group' => 'deliciko-icons'),
               'icon icon-globe' => array('group' => 'deliciko-icons'),
               'icon icon-genius' => array('group' => 'deliciko-icons'),
               'icon icon-map-pin' => array('group' => 'deliciko-icons'),
               'icon icon-dial' => array('group' => 'deliciko-icons'),
               'icon icon-chat' => array('group' => 'deliciko-icons'),
               'icon icon-heart' => array('group' => 'deliciko-icons'),
               'icon icon-cloud' => array('group' => 'deliciko-icons'),
               'icon icon-upload' => array('group' => 'deliciko-icons'),
               'icon icon-download' => array('group' => 'deliciko-icons'),
               'icon icon-target' => array('group' => 'deliciko-icons'),
               'icon icon-hazardous' => array('group' => 'deliciko-icons'),
               'icon icon-piechart' => array('group' => 'deliciko-icons'),
               'icon icon-speedometer' => array('group' => 'deliciko-icons'),
               'icon icon-global' => array('group' => 'deliciko-icons'),
               'icon icon-compass' => array('group' => 'deliciko-icons'),
               'icon icon-lifesaver' => array('group' => 'deliciko-icons'),
               'icon icon-clock' => array('group' => 'deliciko-icons'),
               'icon icon-aperture' => array('group' => 'deliciko-icons'),
               'icon icon-quote1' => array('group' => 'deliciko-icons'),
               'icon icon-scope' => array('group' => 'deliciko-icons'),
               'icon icon-alarmclock' => array('group' => 'deliciko-icons'),
               'icon icon-refresh' => array('group' => 'deliciko-icons'),
               'icon icon-happy' => array('group' => 'deliciko-icons'),
               'icon icon-sad' => array('group' => 'deliciko-icons'),
               'icon icon-facebook' => array('group' => 'deliciko-icons'),
               'icon icon-twitter' => array('group' => 'deliciko-icons'),
               'icon icon-googleplus' => array('group' => 'deliciko-icons'),
               'icon icon-rss' => array('group' => 'deliciko-icons'),
               'icon icon-tumblr' => array('group' => 'deliciko-icons'),
               'icon icon-linkedin' => array('group' => 'deliciko-icons'),
               'icon icon-dribbble' => array('group' => 'deliciko-icons'),
               'icon icon-home' => array('group' => 'deliciko-icons'),
               'icon icon-apartment' => array('group' => 'deliciko-icons'),
               'icon icon-pencil1' => array('group' => 'deliciko-icons'),
               'icon icon-magic-wand' => array('group' => 'deliciko-icons'),
               'icon icon-drop' => array('group' => 'deliciko-icons'),
               'icon icon-lighter' => array('group' => 'deliciko-icons'),
               'icon icon-poop' => array('group' => 'deliciko-icons'),
               'icon icon-sun' => array('group' => 'deliciko-icons'),
               'icon icon-moon' => array('group' => 'deliciko-icons'),
               'icon icon-cloud1' => array('group' => 'deliciko-icons'),
               'icon icon-cloud-upload' => array('group' => 'deliciko-icons'),
               'icon icon-cloud-download' => array('group' => 'deliciko-icons'),
               'icon icon-cloud-sync' => array('group' => 'deliciko-icons'),
               'icon icon-cloud-check' => array('group' => 'deliciko-icons'),
               'icon icon-database' => array('group' => 'deliciko-icons'),
               'icon icon-lock1' => array('group' => 'deliciko-icons'),
               'icon icon-cog' => array('group' => 'deliciko-icons'),
               'icon icon-trash' => array('group' => 'deliciko-icons'),
               'icon icon-dice' => array('group' => 'deliciko-icons'),
               'icon icon-heart1' => array('group' => 'deliciko-icons'),
               'icon icon-star' => array('group' => 'deliciko-icons'),
               'icon icon-star-half' => array('group' => 'deliciko-icons'),
               'icon icon-star-empty' => array('group' => 'deliciko-icons'),
               'icon icon-flag1' => array('group' => 'deliciko-icons'),
               'icon icon-envelope1' => array('group' => 'deliciko-icons'),
               'icon icon-paperclip1' => array('group' => 'deliciko-icons'),
               'icon icon-inbox' => array('group' => 'deliciko-icons'),
               'icon icon-eye' => array('group' => 'deliciko-icons'),
               'icon icon-printer1' => array('group' => 'deliciko-icons'),
               'icon icon-file-empty' => array('group' => 'deliciko-icons'),
               'icon icon-file-add' => array('group' => 'deliciko-icons'),
               'icon icon-enter' => array('group' => 'deliciko-icons'),
               'icon icon-exit' => array('group' => 'deliciko-icons'),
               'icon icon-graduation-hat' => array('group' => 'deliciko-icons'),
               'icon icon-license' => array('group' => 'deliciko-icons'),
               'icon icon-music-note' => array('group' => 'deliciko-icons'),
               'icon icon-film-play' => array('group' => 'deliciko-icons'),
               'icon icon-camera-video' => array('group' => 'deliciko-icons'),
               'icon icon-camera1' => array('group' => 'deliciko-icons'),
               'icon icon-picture1' => array('group' => 'deliciko-icons'),
               'icon icon-book' => array('group' => 'deliciko-icons'),
               'icon icon-bookmark' => array('group' => 'deliciko-icons'),
               'icon icon-user' => array('group' => 'deliciko-icons'),
               'icon icon-users' => array('group' => 'deliciko-icons'),
               'icon icon-shirt' => array('group' => 'deliciko-icons'),
               'icon icon-store' => array('group' => 'deliciko-icons'),
               'icon icon-cart' => array('group' => 'deliciko-icons'),
               'icon icon-tag' => array('group' => 'deliciko-icons'),
               'icon icon-phone-handset' => array('group' => 'deliciko-icons'),
               'icon icon-phone1' => array('group' => 'deliciko-icons'),
               'icon icon-pushpin' => array('group' => 'deliciko-icons'),
               'icon icon-map-marker' => array('group' => 'deliciko-icons'),
               'icon icon-map1' => array('group' => 'deliciko-icons'),
               'icon icon-location' => array('group' => 'deliciko-icons'),
               'icon icon-calendar-full' => array('group' => 'deliciko-icons'),
               'icon icon-keyboard' => array('group' => 'deliciko-icons'),
               'icon icon-spell-check' => array('group' => 'deliciko-icons'),
               'icon icon-screen' => array('group' => 'deliciko-icons'),
               'icon icon-smartphone' => array('group' => 'deliciko-icons'),
               'icon icon-tablet1' => array('group' => 'deliciko-icons'),
               'icon icon-laptop1' => array('group' => 'deliciko-icons'),
               'icon icon-laptop-phone' => array('group' => 'deliciko-icons'),
               'icon icon-power-switch' => array('group' => 'deliciko-icons'),
               'icon icon-bubble' => array('group' => 'deliciko-icons'),
               'icon icon-heart-pulse' => array('group' => 'deliciko-icons'),
               'icon icon-construction' => array('group' => 'deliciko-icons'),
               'icon icon-pie-chart' => array('group' => 'deliciko-icons'),
               'icon icon-chart-bars' => array('group' => 'deliciko-icons'),
               'icon icon-gift1' => array('group' => 'deliciko-icons'),
               'icon icon-diamond' => array('group' => 'deliciko-icons'),
               'icon icon-dinner' => array('group' => 'deliciko-icons'),
               'icon icon-coffee-cup' => array('group' => 'deliciko-icons'),
               'icon icon-leaf' => array('group' => 'deliciko-icons'),
               'icon icon-paw' => array('group' => 'deliciko-icons'),
               'icon icon-rocket' => array('group' => 'deliciko-icons'),
               'icon icon-briefcase1' => array('group' => 'deliciko-icons'),
               'icon icon-bus' => array('group' => 'deliciko-icons'),
               'icon icon-car' => array('group' => 'deliciko-icons'),
               'icon icon-train' => array('group' => 'deliciko-icons'),
               'icon icon-bicycle' => array('group' => 'deliciko-icons'),
               'icon icon-wheelchair' => array('group' => 'deliciko-icons'),
               'icon icon-select' => array('group' => 'deliciko-icons'),
               'icon icon-earth' => array('group' => 'deliciko-icons'),
               'icon icon-smile' => array('group' => 'deliciko-icons'),
               'icon icon-sad1' => array('group' => 'deliciko-icons'),
               'icon icon-neutral' => array('group' => 'deliciko-icons'),
               'icon icon-mustache' => array('group' => 'deliciko-icons'),
               'icon icon-alarm' => array('group' => 'deliciko-icons'),
               'icon icon-bullhorn' => array('group' => 'deliciko-icons'),
               'icon icon-volume-high' => array('group' => 'deliciko-icons'),
               'icon icon-volume-medium' => array('group' => 'deliciko-icons'),
               'icon icon-volume-low' => array('group' => 'deliciko-icons'),
               'icon icon-volume' => array('group' => 'deliciko-icons'),
               'icon icon-mic1' => array('group' => 'deliciko-icons'),
               'icon icon-hourglass1' => array('group' => 'deliciko-icons'),
               'icon icon-undo' => array('group' => 'deliciko-icons'),
               'icon icon-redo' => array('group' => 'deliciko-icons'),
               'icon icon-sync' => array('group' => 'deliciko-icons'),
               'icon icon-history' => array('group' => 'deliciko-icons'),
               'icon icon-clock1' => array('group' => 'deliciko-icons'),
               'icon icon-download1' => array('group' => 'deliciko-icons'),
               'icon icon-upload1' => array('group' => 'deliciko-icons'),
               'icon icon-enter-down' => array('group' => 'deliciko-icons'),
               'icon icon-exit-up' => array('group' => 'deliciko-icons'),
               'icon icon-bug' => array('group' => 'deliciko-icons'),
               'icon icon-code' => array('group' => 'deliciko-icons'),
               'icon icon-link' => array('group' => 'deliciko-icons'),
               'icon icon-unlink' => array('group' => 'deliciko-icons'),
               'icon icon-thumbs-up' => array('group' => 'deliciko-icons'),
               'icon icon-thumbs-down' => array('group' => 'deliciko-icons'),
               'icon icon-magnifier' => array('group' => 'deliciko-icons'),
               'icon icon-cross' => array('group' => 'deliciko-icons'),
               'icon icon-menu' => array('group' => 'deliciko-icons'),
               'icon icon-list' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-up' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-down' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-left' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-right' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-up' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-down' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-left' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-right' => array('group' => 'deliciko-icons'),
               'icon icon-move' => array('group' => 'deliciko-icons'),
               'icon icon-warning' => array('group' => 'deliciko-icons'),
               'icon icon-question-circle' => array('group' => 'deliciko-icons'),
               'icon icon-menu-circle' => array('group' => 'deliciko-icons'),
               'icon icon-checkmark-circle' => array('group' => 'deliciko-icons'),
               'icon icon-cross-circle' => array('group' => 'deliciko-icons'),
               'icon icon-plus-circle' => array('group' => 'deliciko-icons'),
               'icon icon-circle-minus' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-up-circle' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-down-circle' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-left-circle' => array('group' => 'deliciko-icons'),
               'icon icon-arrow-right-circle' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-up-circle' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-down-circle' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-left-circle' => array('group' => 'deliciko-icons'),
               'icon icon-chevron-right-circle' => array('group' => 'deliciko-icons'),
               'icon icon-crop' => array('group' => 'deliciko-icons'),
               'icon icon-frame-expand' => array('group' => 'deliciko-icons'),
               'icon icon-frame-contract' => array('group' => 'deliciko-icons'),
               'icon icon-layers1' => array('group' => 'deliciko-icons'),
               'icon icon-funnel' => array('group' => 'deliciko-icons'),
               'icon icon-text-format' => array('group' => 'deliciko-icons'),
               'icon icon-text-size' => array('group' => 'deliciko-icons'),
               'icon icon-bold' => array('group' => 'deliciko-icons'),
               'icon icon-italic' => array('group' => 'deliciko-icons'),
               'icon icon-underline' => array('group' => 'deliciko-icons'),
               'icon icon-strikethrough' => array('group' => 'deliciko-icons'),
               'icon icon-highlight' => array('group' => 'deliciko-icons'),
               'icon icon-text-align-left' => array('group' => 'deliciko-icons'),
               'icon icon-text-align-center' => array('group' => 'deliciko-icons'),
               'icon icon-text-align-right' => array('group' => 'deliciko-icons'),
               'icon icon-text-align-justify' => array('group' => 'deliciko-icons'),
               'icon icon-line-spacing' => array('group' => 'deliciko-icons'),
               'icon icon-indent-increase' => array('group' => 'deliciko-icons'),
               'icon icon-indent-decrease' => array('group' => 'deliciko-icons'),
               'icon icon-page-break' => array('group' => 'deliciko-icons'),
               'icon icon-hand' => array('group' => 'deliciko-icons'),
               'icon icon-pointer-up' => array('group' => 'deliciko-icons'),
               'icon icon-pointer-right' => array('group' => 'deliciko-icons'),
               'icon icon-pointer-down' => array('group' => 'deliciko-icons'),
               'icon icon-pointer-left' => array('group' => 'deliciko-icons'),
               'icon icon-vplay' => array('group' => 'deliciko-icons'),
               'icon icon-newsletter' => array('group' => 'deliciko-icons'),
               'icon icon-coins-2' => array('group' => 'deliciko-icons'),
               'icon icon-commerce-2' => array('group' => 'deliciko-icons'),
               'icon icon-monitor' => array('group' => 'deliciko-icons'),
               'icon icon-graphic-3' => array('group' => 'deliciko-icons'),
               'icon icon-business' => array('group' => 'deliciko-icons'),
               'icon icon-graphic-2' => array('group' => 'deliciko-icons'),
               'icon icon-commerce-1' => array('group' => 'deliciko-icons'),
               'icon icon-hammer' => array('group' => 'deliciko-icons'),
               'icon icon-graphic-1' => array('group' => 'deliciko-icons'),
               'icon icon-graphic' => array('group' => 'deliciko-icons'),
               'icon icon-justice-1' => array('group' => 'deliciko-icons'),
               'icon icon-line' => array('group' => 'deliciko-icons'),
               'icon icon-money-3' => array('group' => 'deliciko-icons'),
               'icon icon-chart' => array('group' => 'deliciko-icons'),
               'icon icon-commerce' => array('group' => 'deliciko-icons'),
               'icon icon-agenda' => array('group' => 'deliciko-icons'),
               'icon icon-money-2' => array('group' => 'deliciko-icons'),
               'icon icon-justice' => array('group' => 'deliciko-icons'),
               'icon icon-money-1' => array('group' => 'deliciko-icons'),
               'icon icon-money' => array('group' => 'deliciko-icons'),
               'icon icon-technology' => array('group' => 'deliciko-icons'),
               'icon icon-coins-1' => array('group' => 'deliciko-icons'),
               'icon icon-coins' => array('group' => 'deliciko-icons'),
               'icon icon-left-arrow' => array('group' => 'deliciko-icons'),
               'icon icon-bank' => array('group' => 'deliciko-icons'),
               'icon icon-calculator' => array('group' => 'deliciko-icons'),
               'icon icon-chart1' => array('group' => 'deliciko-icons'),
               'icon icon-chart2' => array('group' => 'deliciko-icons'),
               'icon icon-checked' => array('group' => 'deliciko-icons'),
               'icon icon-clock2' => array('group' => 'deliciko-icons'),
               'icon icon-comment' => array('group' => 'deliciko-icons'),
               'icon icon-comments' => array('group' => 'deliciko-icons'),
               'icon icon-consult' => array('group' => 'deliciko-icons'),
               'icon icon-consut2' => array('group' => 'deliciko-icons'),
               'icon icon-deal' => array('group' => 'deliciko-icons'),
               'icon icon-download2' => array('group' => 'deliciko-icons'),
               'icon icon-envelope2' => array('group' => 'deliciko-icons'),
               'icon icon-euro' => array('group' => 'deliciko-icons'),
               'icon icon-folder' => array('group' => 'deliciko-icons'),
               'icon icon-invest' => array('group' => 'deliciko-icons'),
               'icon icon-loan' => array('group' => 'deliciko-icons'),
               'icon icon-map-marker1' => array('group' => 'deliciko-icons'),
               'icon icon-mutual-fund' => array('group' => 'deliciko-icons'),
               'icon icon-percent' => array('group' => 'deliciko-icons'),
               'icon icon-phone2' => array('group' => 'deliciko-icons'),
               'icon icon-pie-chart1' => array('group' => 'deliciko-icons'),
               'icon icon-play' => array('group' => 'deliciko-icons'),
               'icon icon-left-arrow2' => array('group' => 'deliciko-icons'),
               'icon icon-savings' => array('group' => 'deliciko-icons'),
               'icon icon-search1' => array('group' => 'deliciko-icons'),
               'icon icon-tag1' => array('group' => 'deliciko-icons'),
               'icon icon-tags' => array('group' => 'deliciko-icons'),
               'icon icon-tax' => array('group' => 'deliciko-icons'),
               'icon icon-quote11' => array('group' => 'deliciko-icons'),
               'icon icon-right-arrow2' => array('group' => 'deliciko-icons'),
				),
			),
		);
	}
